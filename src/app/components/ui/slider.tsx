...
>(({ className, ...props }, ref) => (
    <SliderPrimitive.Root
        ...
        {...props}
    >
        <SliderPrimitive.Track className="relative h-2 w-full grow overflow-hidden rounded-full bg-zinc-800 dark:bg-zinc-100">
            <SliderPrimitive.Range className="absolute h-full bg-zinc-50 dark:bg-zinc-900" />
